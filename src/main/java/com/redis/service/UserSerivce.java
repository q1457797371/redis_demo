...
import com.redis.utils.DateUtil;
 /**
  * Redis(1)-用redis存储商品-用户关系
  * http://blog.csdn.net/lp1137917045/article/details/45936835
  * @author wjj0065
  *
  */
public class UserSerivce {  
    ...
    public void addLove(String uId, String pId) {  
        ...
        final String date = DateUtil.getNowDatetimeStr();  
    ...
    public Map<String, Date> getUidsByPid(String pId, int count) {  
        ...
        SessionCallback<Map<String, Date>> call = new SessionCallback<Map<String, Date>>() {  
            ...
            public Map<String, String> execute(RedisOperations ops) throws DataAccessException {  
                // TODO Auto-generated method stub  
                ops.multi();  
                ho = ops.opsForHash();  
                ops.exec();  
                return (Map<String, String>) ho.entries(pKey);  
            }  
        };  
    ...
    private Map<String, Date> getPidsByUid(String uId) {  
        ...
        SessionCallback<Map<String, Date>> call = new SessionCallback<Map<String, Date>>() {  
            ...
            public Map<String, String> execute(RedisOperations ops) throws DataAccessException {  
                ...
                ho = ops.opsForHash();  
                ops.exec();  
                return (Map<String, String>) ho.entries(uKey);  
            }  
        };  
        map = redisTemplate.execute(call);  
        return map;  
