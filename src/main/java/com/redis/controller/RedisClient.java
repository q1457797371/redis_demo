...
import com.redis.domain.Person;
...
public class RedisClient {
    ...
    private void saveBean() {
		...
		Person p=new Person();
		p.setName("小张");
		//序列化，反序列化	http://alanland.iteye.com/blog/1600685
		jedis.set("person".getBytes(),SerializeUtil.serialize(p));
		byte[] bytePerson=jedis.get("person".getBytes());
		Person pp=(Person)SerializeUtil.unserialize(bytePerson);
